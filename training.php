...
if (!empty($_POST)) {
   ...
   VALUES ('','{$faculty_name}','{$eid}','{$institute_name}', '{$from_date}', '{$to_date}','{$total_days}','{$uploadfile}')";
                  ...
                  <div class="row jumbotron">
                     <form class="align-items-center" enctype="multipart/form-data" method="POST" action="">
                        <fieldset>
                           ...
                           <div class="form-group row">
                              <label  class="col-md-4 form-control-label" >Industry/Institute Name:</label>
                              <div class="col-md-5"><input class="form-control input-md" type="text" name="institute_name"></div>
                           </div>
                           <div class="form-group row">
                              <label  class="col-md-4 form-control-label" >Worked on the Domain:</label>
                              <div class="col-md-5"><input class="form-control input-md" type="text" name="domain"></div>
                           </div>
                           <div class="form-group row">
